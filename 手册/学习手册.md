...
_请下载并运行扩展库, 然后查看库中对应的markdown文件进行学习_
1.  ui-main页面外框
    学习其用法,注意附带的参数
2.	ui-page子页面
3.	路由页面
...
3.	[echart的使用](https://echarts.baidu.com/examples/index.html)
4.	[axios 网络请求模块](https://www.jianshu.com/p/df464b26ae58)
5.	globalMethod 以$开头的常用公共方法
6.	eventHub 全局事件广播
7.	[vue-touch手势](https://github.com/vuejs/vue-touch/tree/next)
8.	lightbox图片画廊 src/lib/lightbox.md
...
6.	style标签作用域
[阅读资料](https://www.jianshu.com/p/8fd99d8a8eef)
- 页面私有样式-scope
...
###	正确使用v-if/v-show
[阅读资料](https://www.jianshu.com/p/2d3f584be910)
区别:
v-if会触发dom重新渲染
v-show只是用css将dom隐藏
